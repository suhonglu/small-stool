(function() {
    ...
    Page({
        ...
        mapStateToData: function(b) {
            var c = b.wx.user || {}, d = b.wx.enterStatus, e = c.mid, f = c.nick, g = c.hurl, j = {
                navGroup: [ {
                    navPath: "/pages/me/userFocusListPage/userFocusListPage?mid=" + c.mid + "&belonggid=10000",
                    name: "关注",
                    num: c.followCount
                }, {
                    navPath: "/pages/me/userFansListPage/userFansListPage?mid=" + c.mid + "&belonggid=10000",
                    name: "粉丝",
                    num: c.fansCount
                } ]
            }, k = b.me.ownMomentList.hasNext, l = b.me.ownMomentList.kf, m = b.me.ownMomentList.list.map(function(b) {
                var c = i.getBeforeTime(b.ct), d = b.img_data || [], e = d.map(function(b) {
                    if (b) {
                ...
                }), f = b.ginfo, g = 1e5 < b.pv ? "100000+" : b.pv, j = 1e5 < b.uv ? "100000+" : b.uv;
                return f.name && 9 < f.name.length && (f.name = f.name.substr(0, 8) + "..."), h({}, b, {
                    postTime: c,
                    img_data: e,
                    ginfo: f,
                    pv: g,
            ...
            this.setData({
                ...
                hasNext: k,
                list: m,
                nextStartID: m[m.length - 1] ? m[m.length - 1].id : 0,
                ...
                navBar: h({}, this.data.navBar, {
                    midText: "",
                    rightText: "联系客服",
                    onRightTap: l ? "" : "handleContactUs",
                    rightBtnHasContactFn: !!l
                }),
                socialBar: j
            });
        },
        onLoad: function(c) {
            ...
            this.hrefID = c.hrefID, a.xu.mta.Page.init(), j.setChannelData(c), wx.setNavigationBarTitle({
                title: "个人中心"
            }), j.getUserAuthorize(a, b, d, this.handleFetchMainData());
        },
        handleFetchMainData: function() {
            var b = this, c = a.sysInfo.SDKVersion && 124 <= 1 * a.sysInfo.SDKVersion.replace(/\./g, "");
            this.setData({
                shouldShowFeedShareBtn: c
            });
        },
        onReady: function() {
            var a = this, b = this.data.list;
            b.find(function(b, c) {
                return !(b.id !== +a.hrefID) && (hrefIndex = c, a.setData({
                    hrefIndex: c
                }), !0);
            }), setTimeout(function() {
                a.setData({
        ...
        onScrollViewReachBottom: function() {
            var c = this, d = c.data.list, f = c.data.hasNext, g = c.data.nextStartID, h = this.data.reachBottomRequestLock;
            !h && f && (this.setData({
                reachBottomRequestLock: 1,
                reachBottomFetchFail: !1
            }), wx.showNavigationBarLoading(), b(e.fetchMyMomentList({
                token: a.xu.token,
                nextStartID: g,
                complete: function() {
                    c.setData({
                        reachBottomRequestLock: 0,
